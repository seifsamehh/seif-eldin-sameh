        ...
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
          <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-900">
            <p className="relative px-6 py-1 text-lg italic text-center text-gray-100">
              ...
              اجمد ويب ديفيلوبر و ان شاء الله هعمل تحت ايده احلى شغل
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                fill="currentColor"
          ...
          <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-[#00b5e7] dark:text-gray-900">
            <p className="text-xl font-semibold leadi">Omar Ahmed</p>
        ...
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
          <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-900">
            <p className="relative px-6 py-1 text-lg italic text-center text-gray-100">
              ...
              Seif, ich möchte, dass du weißt, dass deine harte Arbeit nicht
              unbemerkt geblieben ist. Dein Portfolio ist eine wahre Reflektion
              deines Talents, deiner Hingabe und deines Ehrgeizes. Ich bin
              wirklich stolz darauf, jemanden so begabten wie dich zu kennen,
              und ich bin zuversichtlich, dass du weiterhin bedeutende Beiträge
              auf dem Gebiet der Webentwicklung leisten wirst.
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                fill="currentColor"
          ...
          <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-[#00b5e7] dark:text-gray-900">
            <p className="text-xl font-semibold leadi">Abdelwahb Elsayed</p>
            <p className="text-sm uppercase">Full Stack Web developer</p>
          </div>
        </div>
      </div>
    </section>
