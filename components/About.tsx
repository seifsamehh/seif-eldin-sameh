...
export default function About() {
  useGSAP(() => {
    const text = document.querySelector(".text .about-text-inner");
  ...
  return (
    <section className="about min-h-screen min-[290px]:hidden md:block">
      <div className="track">
        <div className="overlay">
          <div className="text">
            <div className={`${Franchise.className} about-text-inner`}>
