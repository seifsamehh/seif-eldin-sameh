...
import qr from "../assests/images/qr.webp";
...
export default function Contact() {
  return (
    <>
      <main>
        {/* start contact */}
        <section className="contact h-screen flex justify-center items-center gap-8 flex-col overflow-x-hidden">
          <h1
            className={`${playfair.className} text-center min-[290px]:text-5xl md:text-7xl mb-12`}
          >
            CONTACT ME
          </h1>
          <div className="contact-content flex justify-center items-center gap-8 min-[290px]:flex-wrap md:flex-nowrap">
            <div className="left">
            ...
            <div className="right">
              <Link href="https://linko.page/roq6enpo7h42" target="_blank">
                <Image
                  src={qr}
                  alt="qr code"
                  width={200}
